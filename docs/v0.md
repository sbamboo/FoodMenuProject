...
?excludeWeekends excludes all saturdays and sundays.

?excludeHolidays excludes the Swedish national holidays:
...
Additionally, you can use the ?day parameter can be used to retrieve a specific weekday (1 = Monday to 7 = Sunday). If the specified day is not available in the dataset, the response will be empty.